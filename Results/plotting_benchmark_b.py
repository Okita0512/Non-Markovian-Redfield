...
data2 = np.loadtxt("benchmark_b_Redfield.txt", dtype = float)
plt.plot(data2[:, 0], data2[:, 1] - data2[:, 7], "-", linewidth = 2.0, color = 'red', label = "Redfield")

data2 = np.loadtxt("benchmark_b.dat", dtype = float)
...
ax.set_title('Benchmark b', font = 'Times New Roman', size = 20)
...
plt.savefig("Benchmark b.pdf", bbox_inches='tight')