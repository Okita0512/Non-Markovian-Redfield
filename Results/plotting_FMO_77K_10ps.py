...
data2 = np.loadtxt("FMO_77K_Redfield.txt", dtype = float)
x = 1
...
data2 = np.loadtxt("FMO_77K.dat", dtype = float)
...
# population range
y1, y2 = -0.1, 1.4     # y-axis range: (y1, y2)
...
ax.set_title('The Fenna-Matthews-Olson (FMO) pigment-protein complex @ 77K', font = 'Times New Roman', size = 15, pad = 20)
...
plt.savefig("FMO 77K 10ps.pdf", bbox_inches='tight')