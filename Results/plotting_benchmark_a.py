...
data2 = np.loadtxt("benchmark_a_Redfield.txt", dtype = float)
plt.plot(data2[:, 0], data2[:, 1] - data2[:, 7], "-", linewidth = 2.0, color = 'red', label = "Redfield")

data2 = np.loadtxt("benchmark_a.dat", dtype = float)
plt.plot(data2[:, 0], data2[:, 1], "o", linewidth = 2.0, color = 'navy', label = "Benchmark in J. Chem. Phys. 143, 194108 (2015)")
...
ax.set_title('Benchmark a', font = 'Times New Roman', size = 20)
...
plt.savefig("Benchmark a.pdf", bbox_inches='tight')